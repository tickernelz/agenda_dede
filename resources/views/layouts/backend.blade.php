...
<head>
    ...
    <title>@yield('judul') | AGENDA DINKES</title>

    <meta name="description" content="AGENDA DINKES">
    <meta name="author" content="Ahmad Kamilen">
...
<div id="page-container"
     class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-modern main-content-narrow enable-cookies">
    <!-- Side Overlay-->
            ...
            <div class="content-header-section align-parent">
                ...
                <div class="content-header-item">
                    ...
                    <a class="align-middle link-effect text-primary-dark font-w600"
                       href="javascript:void(0)">{{ \App\Http\Controllers\BackendController::getNama() }}</a>
                </div>
                <!-- END User Info -->
            </div>
        </div>
                ...
                <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                    ...
                    <div class="content-header-item">
                        <a class="link-effect font-w700" href="/">
                            ...
                            <span class="font-size-xl text-dual-primary-dark">agenda</span><span
                                class="font-size-xl text-primary">kegiatan</span>
                        </a>
                    </div>
                    <!-- END Logo -->
                </div>
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li>
                            <a class="{{ request()->is('user', 'user/*') ? ' active' : '' }}" href="{{ route('index-user') }}">
...
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <a class="{{ request()->is('pages/slick') ? ' active' : '' }}" href="/pages/slick">Slick--}}
{{--                                        Slider</a>--}}
{{--                                </li>--}}
{{--                                <li>--}}
...
{{--                        </li>--}}
                        <li class="nav-main-heading">
                            <span class="sidebar-mini-visible">MR</span><span class="sidebar-mini-hidden">Kelola</span>
                        </li>
                        <li>
                            <a href="/">
    ...
    <footer id="page-footer">
        <div class="content py-20 font-size-sm clearfix">
            <div class="float-right">
                Crafted with Laravel by <a class="font-w600" href="https://1.envato.market/ydb" target="_blank">Ahmad
                    Kamilen</a>
            </div>
            <div class="float-left">
                <a class="font-w600" href="https://1.envato.market/95j" target="_blank">DINKES PROV KALIMANTAN
                    TENGAH</a> &copy; <span class="js-year-copy"></span>
            </div>
        </div>
    </footer>
    <!-- END Footer -->
